...
namespace JailTalk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230701073533_AddGenderField")]
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.Jail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "MLP-PN-SJ",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 7, 1, 7, 35, 33, 496, DateTimeKind.Unspecified).AddTicks(9712), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Ponnani Sub Jail",
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 7, 1, 7, 35, 33, 496, DateTimeKind.Unspecified).AddTicks(9721), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
