...
namespace JailTalk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230630084438_RelationshipSeederAdded")]
    partial class RelationshipSeederAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.Jail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "MLP-PN-SJ",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 6, 30, 8, 44, 38, 677, DateTimeKind.Unspecified).AddTicks(7640), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Ponnani Sub Jail",
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 6, 30, 8, 44, 38, 677, DateTimeKind.Unspecified).AddTicks(7647), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
