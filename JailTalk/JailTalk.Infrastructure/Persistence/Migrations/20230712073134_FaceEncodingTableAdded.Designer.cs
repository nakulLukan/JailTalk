...
namespace JailTalk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230712073134_FaceEncodingTableAdded")]
    partial class FaceEncodingTableAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JailTalk.Domain.Identity.AppFaceEncoding", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_app_face_encoding");

                    b.ToTable("app_face_encoding", (string)null);
                });
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.PrisonerFaceEncodingMapping", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_prisoner_face_encoding_mapping");

                    b.HasIndex("FaceEncodingId")
                        .IsUnique()
                        .HasDatabaseName("ix_prisoner_face_encoding_mapping_face_encoding_id");

                    b.HasIndex("PrisonerId")
                        .HasDatabaseName("ix_prisoner_face_encoding_mapping_prisoner_id");

                    b.ToTable("prisoner_face_encoding_mapping", (string)null);
                });
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.PrisonerFaceEncodingMapping", b =>
                {
                    b.HasOne("JailTalk.Domain.Identity.AppFaceEncoding", "FaceEncoding")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prisoner_face_encoding_mapping_app_face_encoding_face_encod");
                    ...
                    b.HasOne("JailTalk.Domain.Prison.Prisoner", "Prisoner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prisoner_face_encoding_mapping_prisoners_prisoner_id");
