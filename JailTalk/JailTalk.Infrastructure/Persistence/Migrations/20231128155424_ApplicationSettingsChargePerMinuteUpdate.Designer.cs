...
namespace JailTalk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231128155424_ApplicationSettingsChargePerMinuteUpdate")]
    partial class ApplicationSettingsChargePerMinuteUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttachmentPhoneDirectory", b =>
                {
                    b.Property<int>("IdProofAttachmentsId")
                        .HasColumnType("integer")
                        .HasColumnName("id_proof_attachments_id");

                    b.Property<long>("PhoneDirectoryId")
                        .HasColumnType("bigint")
                        .HasColumnName("phone_directory_id");

                    b.HasKey("IdProofAttachmentsId", "PhoneDirectoryId")
                        .HasName("pk_attachment_phone_directory");

                    b.HasIndex("PhoneDirectoryId")
                        .HasDatabaseName("ix_attachment_phone_directory_phone_directory_id");

                    b.ToTable("attachment_phone_directory", (string)null);
                });
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.Jail", b =>
                {
                    ...
                    b.Property<bool>("IsSystemTurnedOff")
                        .HasColumnType("boolean")
                        .HasColumnName("is_system_turned_off");
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.PhoneDirectory", b =>
                {
                    ...
                    b.Property<string>("IdProofValue")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("id_proof_value");
                    ...
                    b.Property<bool>("IsCallRecordingAllowed")
                        .HasColumnType("boolean")
                        .HasColumnName("is_call_recording_allowed");
            ...
            modelBuilder.Entity("JailTalk.Domain.System.ApplicationSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsReadonly = false,
                            LastUpdateBy = "System",
                            LastUpdatedOn = new DateTimeOffset(new DateTime(2023, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            RegexValidation = "^(true|false)$",
                            Value = "True"
                        },
                        new
                        {
                            ...
                            LastUpdateBy = "System",
                            LastUpdatedOn = new DateTimeOffset(new DateTime(2023, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            RegexValidation = "^[0-9]+[0-9]+[:][0-9]+[0-9]+[-][0-9]+[0-9]+[:][0-9]+[0-9]+$",
                            Value = "09:00-20:00"
                        });
                });
            ...
            modelBuilder.Entity("AttachmentPhoneDirectory", b =>
                {
                    b.HasOne("JailTalk.Domain.System.Attachment", null)
                        .WithMany()
                        .HasForeignKey("IdProofAttachmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_attachment_phone_directory_attachments_id_proof_attachments");

                    b.HasOne("JailTalk.Domain.Prison.PhoneDirectory", null)
                        .WithMany()
                        .HasForeignKey("PhoneDirectoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_attachment_phone_directory_phone_directory_phone_directory_");
                });
            ...
            modelBuilder.Entity("JailTalk.Domain.Prison.PhoneDirectory", b =>
                {
                    b.HasOne("JailTalk.Domain.Lookup.LookupDetail", "IdProofType")
                        ...
                        .HasConstraintName("fk_phone_directory_lookup_details_id_proof_type_id");
